...
const Movies = () => {
  ...
  return (
    ...
    <button onClick={onChangePrev} className='flex items-center justify-center rounded-md bg-green-600 h-8 w-20 hover:bg-yellow-500'><AiOutlineArrowLeft color='white' size={20}/>Prev</button>
    <button onClick={onChangeNext} className='flex items-center justify-center rounded-md bg-green-600 h-8 w-20 hover:bg-yellow-500'>Next<AiOutlineArrowRight color='white' size={20}/></button>
    </div>
